...
import {PreventLoggedInAccessGuard} from "./services/prevent-logged-in-access.guard.service";
...
const appRoutes: Routes = [
  ...
  { path: 'auth', component: AuthenticationComponent, canActivate: [PreventLoggedInAccessGuard] },
